...
Stitch by Google is connected via MCP for AI-driven UI design generation. It uses
Gemini to generate UI designs and HTML/CSS from natural language prompts.
