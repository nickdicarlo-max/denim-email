export const ROLE_OPTIONS = [
  {
    ...
    description: "Schools, activities, sports teams",
  ...
  },
  {
    ...
    description: "Tenants, vendors, maintenance",
    domain: "property",
  },
  {
    id: "construction",
    ...
    description: "Job sites, subs, permits",
    domain: "construction",
  },
  {
    id: "legal",
    ...
    icon: "\u2696\uFE0F",
    materialIcon: "gavel",
    description: "Clients, matters, filings",
    domain: "legal",
  },
  {
    id: "agency",
    ...
    description: "Client projects, deliverables",
    domain: "agency",
  },
  {
    id: "other",
    ...
    description: "Any topic you track by email",
    domain: "general",
  },
] as const;
