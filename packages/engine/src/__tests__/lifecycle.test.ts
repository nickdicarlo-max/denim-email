...
import { computeCaseDecay, computeNextActionDate } from "../actions/lifecycle";
...
describe("computeNextActionDate", () => {
    ...
    const actions = [
      {
        ...
        dueDate: null,
        eventStartTime: new Date("2026-04-02T17:30:00Z"),
      },
    ];
  ...
  it("returns null when PENDING actions have no dates", () => {
    const actions = [{ status: "PENDING" as const, dueDate: null, eventStartTime: null }];
    expect(computeNextActionDate(actions)).toBeNull();
  });
});
    ...
    const result = computeCaseDecay(
      {
        ...
        actions: [
          ...
          },
          {
            ...
            status: "PENDING",
            dueDate: null,
            eventStartTime: new Date("2026-04-05"),
            eventEndTime: null,
          },
        ],
        ...
        actions: [
          {
            id: "a1",
            status: "PENDING",
            dueDate: new Date("2026-04-02T10:00:00Z"),
            eventStartTime: null,
            eventEndTime: null,
          },
        ],
        ...
        actions: [
          {
            ...
            status: "PENDING",
            dueDate: null,
            eventStartTime: new Date("2026-04-05T10:00:00Z"),
            eventEndTime: null,
          },
        ],
        lastEmailDate: new Date("2026-03-28"),
        ...
        actions: [
          {
            ...
            status: "PENDING",
            dueDate: null,
            eventStartTime: new Date("2026-04-20"),
            eventEndTime: null,
          },
        ],
        lastEmailDate: new Date("2026-03-28"),
