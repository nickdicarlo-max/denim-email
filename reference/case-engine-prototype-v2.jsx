...
function CaseCard({ caseData, onTap }) {
  return (
    ...
    >
      ...
      {caseData.entity && (
        <div
          style={{ fontSize: "12px", color: T.textSecondary, marginBottom: "8px", lineHeight: 1.4 }}
        >
...
function ExcludeSheet({ email, onExclude, onClose }) {
  return (
    <Sheet onClose={onClose} title="Exclude from scans" subtitle={`"${email.subject}"`}>
      <div
        style={{ fontSize: "13px", color: T.textSecondary, lineHeight: 1.5, marginBottom: "12px" }}
      >
        This email will be removed from this case. How should we handle similar emails in the
        future?
      </div>
      <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
        <SheetRow
    ...
    return (
      <Sheet onClose={onClose} title="Add a new topic" large>
        ...
        <div style={{ marginTop: "8px", fontSize: "11px", color: T.textMuted, lineHeight: 1.4 }}>
          The more you share, the better we can organize your email. Include who you work with and
          what kinds of things you're tracking.
        </div>
        <button
          onClick={() => {
            if (desc.trim()) setStep(1);
          }}
          disabled={!desc.trim()}
          style={{
            marginTop: "16px",
          ...
          <div style={{ marginTop: "24px", textAlign: "left" }}>
            {[
              ...
              >
                ...
                />
                <span style={{ fontSize: "12px", color: T.textSecondary, flex: 1 }}>
                  {item.label}
                </span>
                <span style={{ fontSize: "12px", color: T.textMuted, fontFamily: T.fontMono }}>
                  {item.value}
                </span>
              </div>
            ))}
  ...
  if (step === 2) {
    return (
      <Sheet onClose={onClose} title="Here's what I set up" large>
        ...
        >
          Based on your description and your recent email, I created a topic with these settings.
          Tap to adjust anything.
        </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {subtitle && (
          <p
            style={{ fontSize: "12px", color: T.textMuted, margin: "0 0 12px 0", lineHeight: 1.4 }}
          >
            {subtitle}
          </p>
        )}
...
function CaseDetail({
  ...
  return (
    <div style={{ height: "100%", display: "flex", flexDirection: "column", background: T.bg }}>
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ fontSize: "11px", color: T.textMuted, marginTop: "1px" }}>
            {topicName}
            {caseData.entity ? ` / ${caseData.entity}` : ""}
          </div>
        </div>
      </div>
            ...
            {[
              {
                dir: "up",
                icon: Icons.thumbUp,
                active: T.successSoft,
                activeColor: T.successText,
                activeBorder: T.successText,
              ...
              },
              {
                ...
                active: T.errorSoft,
                activeColor: T.errorText,
                activeBorder: T.errorText,
      ...
      {showExcludeSheet && (
        <ExcludeSheet
          email={showExcludeSheet}
          onExclude={handleExclude}
          onClose={() => setShowExcludeSheet(null)}
        />
      )}
    ...
    <div style={{ height: "100%", display: "flex", flexDirection: "column", background: T.bg }}>
      ...
      <div style={{ flex: 1, overflow: "auto", padding: "16px" }}>
          ...
          {isTracking ? (
            <>
              ...
              <div style={{ fontSize: "13px", color: T.textSecondary, marginTop: "4px" }}>
                Case accuracy (rolling)
              </div>
              <div style={{ fontSize: "11px", color: T.textMuted, marginTop: "2px" }}>
                {negatives} negative signal{negatives !== 1 ? "s" : ""} out of {metrics.casesViewed}{" "}
                cases viewed
              </div>
            </>
          ) : (
        ...
        >
          ...
          <div style={{ fontSize: "12px", color: T.textSecondary, lineHeight: 1.5 }}>
            ...
            <div style={{ marginTop: "6px" }}>
              Thumbs up and case views are positive signals. Email moves, thumbs down, and
              case-level corrections count against accuracy. Score appears after {needed} signals.
            </div>
          </div>
        </div>
        ...
        >
          ...
          {eventLog.length === 0 ? (
            <div
              style={{ padding: "16px", textAlign: "center", fontSize: "12px", color: T.textMuted }}
            >
            ...
            eventLog.slice(0, 30).map((evt, i) => (
              <div
                ...
                style={{
                  padding: "8px 12px",
                  borderBottom:
                    i < Math.min(eventLog.length, 30) - 1 ? `1px solid ${T.borderLight}` : "none",
                  fontSize: "11px",
                  fontFamily: T.fontMono,
                  display: "flex",
                  gap: "8px",
              ...
              >
                ...
                <span
                  style={{
                    color: evt.type.includes("up")
                      ? T.success
                      : evt.type.includes("down")
                        ? T.error
                        : evt.type.includes("move")
                          ? T.warn
                          : evt.type.includes("exclude")
                            ? T.textSecondary
                            : T.accent,
                    fontWeight: 500,
                    flexShrink: 0,
...
export default function CaseEnginePrototype() {
  ...
  const handleEmailMove = (fromCaseId, emailId, toCaseId) => {
    setMetrics((m) => ({
      ...m,
      emailMoves: m.emailMoves + 1,
      corrections: m.corrections + 1,
      signalsCollected: m.signalsCollected + 1,
    }));
  ...
  const handleEmailExclude = (emailId, type, value) => {
    setMetrics((m) => ({
      ...m,
      emailExcludes: m.emailExcludes + 1,
      signalsCollected: m.signalsCollected + 1,
    }));
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
            ...
            <div style={{ cursor: "pointer", color: T.textMuted, display: "flex", padding: "4px" }}>
              {Icons.settings}
            </div>
          </div>
        </div>
